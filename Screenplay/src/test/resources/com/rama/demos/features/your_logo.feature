Feature: comprar ropa
  ...
  Scenario Outline: Registrar usuario
    ...
    Examples:
      ...
      | "http://automationpractice.com/index.php" | prouleummegeco-13@yopmail.com | Jhonatan  | Nagles   | 124@*#GLsa | 26-October-2011 | Atrato river | cra 164-567 | calle 164-567 | Norcross | Georgia | 30003      | Prueba de registro de usuario | 214567890 | 9876754567  | Mis compras |
